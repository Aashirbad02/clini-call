          ...
          <div class="lg:col-span-2">
            <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
              <div class="md:col-span-5">
                ...
                <input type="text" name="full_name" id="full_name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder='John Krasinski' />
              </div>
              ...
              <div class="md:col-span-5">
                ...
                <input type="number" name="phone" id="phone" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="7989898989" />
              </div>
               
              <div class="md:col-span-2">
                <label for="address">Age</label>
                <input type="number" name="address" id="address" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 " value="" placeholder="19" />
              </div>

              <div class="md:col-span-2">
                <label for="city">Blood Group</label>
                <input type="text" name="city" id="city" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="B+" />
              </div>
              <div class="md:col-span-2">
                <label for="address">Height</label>
                <input type="number" name="address" id="address" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 " value="" placeholder="5'7" />
              </div>

              <div class="md:col-span-2">
                <label for="city"> Weight</label>
                <input type="number" name="city" id="city" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="62" />
              </div>

              <div class="md:col-span-2">
                <label for="number">Password</label>
                <input type="text" name="password" id="phone" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="Kiwis786" />
              </div> 
               <div class="md:col-span-2">
                <label for="number">Confirm Password</label>
                <input type="text" name="cpassword" id="phone" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" placeholder="Kiwis786" />
              </div>
