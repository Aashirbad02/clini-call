...
const Login = () => {
  ...
  {/* <!-- login container --> */}
  <div class="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center mt-20">
    {/* <!-- form --> */}
    <div class="md:w-1/2 px-8 md:px-16">
      ...
      <div class="mt-3 text-xs flex justify-between items-center text-[#002D74]">
        ...
        <button class="py-2 px-5 bg-[#002D74] text-white border rounded-xl hover:scale-110 duration-300">Register</button>
      </div>
    </div>
